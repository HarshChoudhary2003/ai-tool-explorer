      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-2 text-sm">
              <Link to="/tools?category=llm" className="text-muted-foreground hover:text-primary transition-colors">
                Language Models
              </Link>
              <Link to="/tools?category=image_generation" className="text-muted-foreground hover:text-primary transition-colors">
                Image Generation
              </Link>
              <Link to="/tools?category=voice" className="text-muted-foreground hover:text-primary transition-colors">
                Voice & Audio
              </Link>
              <Link to="/tools?category=automation" className="text-muted-foreground hover:text-primary transition-colors">
                Automation
              </Link>
              <Link to="/tools?category=code_assistant" className="text-muted-foreground hover:text-primary transition-colors">
                Code Assistants
              </Link>
            </nav>
          </div>
