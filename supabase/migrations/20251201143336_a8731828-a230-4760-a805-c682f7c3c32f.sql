...
-- RLS Policies for ai_tools (public read, admin write)
...
-- RLS Policies for comparisons (users can manage their own)
CREATE POLICY "Users can view their own comparisons"
  ON public.tool_comparisons
  FOR SELECT
  TO authenticated
...
CREATE INDEX idx_ai_tools_has_api ON public.ai_tools(has_api);
...
-- Insert sample data (30+ AI tools)
